...
include('db_config.php');
    ...
    $paymentdetails['order_id'] = $_POST['orderNo'];
...
//print_r($order_status." ,".$trans_check_result_value." ,". $payment_trans_result_value." ,". $cartamountresultvalue['total_cart_amount']." ,". $paymentdetails['amount']);
//die();
